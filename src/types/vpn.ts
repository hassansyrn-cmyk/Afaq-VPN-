...
export interface ProvisioningStatus { isRegistered: boolean; hasIdentity: boolean; legacyFallbackEnabled?: boolean; address?: string; endpoint?: string; hasValidConfig?: boolean; }
