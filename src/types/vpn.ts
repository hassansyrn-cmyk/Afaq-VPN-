...
export interface ProvisioningStatus { isRegistered: boolean; hasIdentity: boolean; address?: string; endpoint?: string; }
export interface ProvisioningResult { state: 'registered' | 'failed'; existing?: boolean; error?: string; isRecoverableError?: boolean; }
